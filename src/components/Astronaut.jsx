...
export function Astronaut(props) {
  ...
  useEffect(() => {
    ySpring.set(-1);//it starts from 5 which is top position of 3d model and then come to original position that is -1 so it will create a falling animation from top
  }, [ySpring]);
  ...
  return (
    <group
     ...
     >{/* if above 853 pixels that means dekstop view then use this cordinates for 3d model */}
