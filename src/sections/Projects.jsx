...
const x = useMotionValue(0);// this is used so that preview image moves with cursor when we hover over it
...
const [preview, setPreview] = useState(null)
  ...
  return (
    <section id="projects"
    onMouseMove={handleMouseMove} className="relative c-space section-spacing">
