       ...
       md:auto-rows-[18rem] mt-12'>
        {/* Grid 1 */}
         <div className='flex items-end grid-default-color grid-1'>
           ...
           />
           <div className='z-10'>
            <p className='headtext'>Hi, I'm Gagan</p>
            <p className='subtext'>
              Over the last 2 years, I developed my frontend and backend dev
              skills to deliever dynamic, software and web applications.
            </p>
           </div>
        ...
        {/* Grid 4 */}
         <div className='grid-special-color grid-4'>
          ...
          gap-4 size-full'>
             <p className='text-center headtext item '>
        ...
        {/* Grid 5 */}
         <div className='grid-default-color grid-5'>
           <div className='z-10 w-[50%]'>
             ...
             <p className='subtext'>I specialize in a variety of languages, frameworks, and tools
