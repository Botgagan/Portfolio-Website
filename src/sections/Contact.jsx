...
const handleSubmit = async (e) => {
  ...
  try {
    console.log("from submitted", formData);
     ...
     await emailjs.send("service_06jvtec","template_7r0r91t",{
    from_name: formData.name,
    from_email: formData.email,
    to_email: "gagan112002@gmail.com",
        ...
        <form onSubmit={handleSubmit} className='w-full'>
          ...
          <div className='mb-5'>
            ...
            <input
              ...
              type='email' 
              className='field-input field-input-focus' 
              placeholder='williambell67@gmail.com'
              autoComplete='email'
          ...
          <div className='mb-5'>
            ...
            to-royal hover-animation'>{isLoading ? "Sending..." : "Send"}</button>
        </form>
      </div>
    </section>
  )
